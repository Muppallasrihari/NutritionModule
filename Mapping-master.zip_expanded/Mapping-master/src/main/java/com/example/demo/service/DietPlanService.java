...
import com.example.demo.exception.NutritionIdException;
...
public class DietPlanService {
	...
	public DietPlan saveDietPlan(DietPlan dietPlan) {
		try {
			...
			throw new NutritionIdException("This Diet-Plan: "+dietPlan.getId()+" already exists");
		}
		}
public DietPlan getDietPlanById(String customerIdentifier) {
	...
	if(diet==null) {
		throw new NutritionIdException("Id: "+customerIdentifier+" not exists");
	}
	return diet;
}
